...
#ifndef CALCULATIONS_CALCS_CCALCJOINTFREQDIST_H_
#define CALCULATIONS_CALCS_CCALCJOINTFREQDIST_H_
...
class CCalcJointFreqDist : public ICalculation {
 private:
  // Inputs
...
public:
  ICalculation* clone() const { return new CCalcJointFreqDist(); /*clone*/  }
};

#endif /* CALCULATIONS_CALCS_CCALCJOINTFREQDIST_H_ */
