...
#ifndef CALCULATIONS_CALCS_CCALCMISMATCH_H_
#define CALCULATIONS_CALCS_CCALCMISMATCH_H_
...
class CCalcMismatch : public ICalculation {
 private:
  // Inputs
  CDataInt *ploidy;
  CDataIntVector *nsam;
 ...
 public:
  ICalculation* clone() const { return new CCalcMismatch(); /*clone*/  }
};


#endif /* CALCULATIONS_CALCS_CCALCMISMATCH_H_ */
