...
{
    RansAssert((scale_bits <= 16) && "RansAssert(scale_bits <= 16)");
    RansAssert((start <= (1u << scale_bits)) && "RansAssert(start <= (1u << scale_bits))");
    RansAssert((freq <= (1u << scale_bits) - start) && "RansAssert(freq <= (1u << scale_bits) - start)");
...
{
    RansAssert(start <= (1 << 16) && "RansAssert(start <= (1 << 16))");
    RansAssert((freq <= (1 << 16) - start) && "RansAssert(freq <= (1 << 16) - start)");
...
{
    RansAssert(sym->x_max != 0 && "RansAssert(sym->x_max != 0)"); // can't encode symbol with freq=0
