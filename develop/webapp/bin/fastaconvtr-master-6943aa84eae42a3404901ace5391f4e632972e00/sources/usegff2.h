...
/*
 ...
 subset_positions: string with the 'feature' value to filter: in case coding region use synonymous, nonsynonymous, silent, 0-fold, 2-fold, 3-fold, 4-fold. Also noncoding. <- defined before
