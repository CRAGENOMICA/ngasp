...
/// Command options: New & Not done
  ...
  MSTATSPOP_KIND_LENGTH_SHORT,
  MSTATSPOP_KIND_LENGTH_LONG,
  MSTATSPOP_KIND_LENGTH_DESC,

  MSTATSPOP_LOCATION_MISSING_SHORT,
  MSTATSPOP_LOCATION_MISSING_LONG,
  MSTATSPOP_LOCATION_MISSING_DESC,

  MSTATSPOP_FIRST_SLIDE_SHORT,
  MSTATSPOP_FIRST_SLIDE_LONG,
  MSTATSPOP_FIRST_SLIDE_DESC,
