...
kernel-headers 
origin_url = http://ftp.csuc.cat/centos/7.6.1810/updates/x86_64/Packages/kernel-headers-3.10.0-957.10.1.el7.x86_64.rpm
kernel-devel 
origin_url = http://ftp.csuc.cat/centos/7.6.1810/updates/x86_64/Packages/kernel-devel-3.10.0-957.10.1.el7.x86_64.rpm
gcc-c++ 
origin_url = http://ftp.csuc.cat/centos/7.6.1810/updates/x86_64/Packages/gcc-c%2B%2B-4.8.5-36.el7_6.1.x86_64.rpm
libstdc++-devel 
origin_url = http://ftp.csuc.cat/centos/7.6.1810/updates/x86_64/Packages/libstdc%2B%2B-devel-4.8.5-36.el7_6.1.x86_64.rpm
make 
origin_url = http://mirror.gadix.com/centos/7.6.1810/os/x86_64/Packages/make-3.82-23.el7.x86_64.rpm
    bzip2 
  origin_url = http://mirror.gadix.com/centos/7.6.1810/os/x86_64/Packages/bzip2-1.0.6-13.el7.x86_64.rpm  
    boost 
    origin_url = http://mirror.gadix.com/centos/7.6.1810/os/x86_64/Packages/boost-1.53.0-27.el7.x86_64.rpm
    boost-devel 
    origin_url = http://ftp.csuc.cat/centos/7.6.1810/os/x86_64/Packages/boost-devel-1.53.0-27.el7.x86_64.rpm
    boost-system 
    origin_url = http://ftp.csuc.cat/centos/7.6.1810/os/x86_64/Packages/boost-system-1.53.0-27.el7.x86_64.rpm
    boost-filesystem 
    origin_url = http://mirror.gadix.com/centos/7.6.1810/os/x86_64/Packages/boost-filesystem-1.53.0-27.el7.x86_64.rpm
    boost-thread 
    origin_url = http://mirror.gadix.com/centos/7.6.1810/os/x86_64/Packages/boost-thread-1.53.0-27.el7.x86_64.rpm
    wget 
    origin_url = http://ftp.csuc.cat/centos/7.6.1810/os/x86_64/Packages/wget-1.14-18.el7.x86_64.rpm
    git 
    origin_url = http://ftp.csuc.cat/centos/7.6.1810/updates/x86_64/Packages/git-1.8.3.1-20.el7.x86_64.rpm
    zip 
    origin_url = http://mirror.gadix.com/centos/7.6.1810/os/x86_64/Packages/zip-3.0-11.el7.x86_64.rpm
    unzip 
    origin_url = http://mirror.gadix.com/centos/7.6.1810/os/x86_64/Packages/unzip-6.0-19.el7.x86_64.rpm
    psmisc 
